...
class LoginSystem {
	...
	/* Start Config */
 	...
 	private $dbpass = "zigmas112"; // MySQL Database Password
 	private $dbname = "jvanautos"; // Database Name
 	...
 	private $loginPage    = "http://127.0.0.1/secure/home/login"; // The login page. ex : /login.php or /accounts/login.php
 	private $homePage     = "http://127.0.0.1/secure/home/"; // The home page. The main page for logged in users. Redirects to here when logs in
 	/* End Config */
