...
class LoginSystem {
	...
	/* Start Config */
 	private $dbhost = "jvandenbergautos.nl.mysql"; // Host Name
 	private $dbport = "3306"; //Port
 	private $dbuser = "jvandenbergauto"; // MySQL Database Username
 	private $dbpass = "VAXMSEDE"; // MySQL Database Password
 	private $dbname = "jvandenbergauto"; // Database Name
 	...
 	private $company      = "http://jvandenbergautos.nl"; // Company for name for including in emails
 	var $phpsessionstart  = true; // Should I Start A PHP Session
 	var $emailLogin       = false; // Make Login With Username & E-Mail Possible
 	var $rememberMe       = false; // Add Remember Me Feature.
 	...
 	private $loginPage    = "http://127.0.0.1/jvanautos/home/login"; // The login page. ex : /login.php or /accounts/login.php
 	private $homePage     = "http://127.0.0.1/jvanautos/occasions/index/1"; // The home page. The main page for logged in users. Redirects to here when logs in
 	/* End Config */
